...
alter TABLE books MODIFY COLUMN title VARCHAR(80);
...
ALTER TABLE books ADD COLUMN Rental_Price DECIMAL(10,2);
ALTER TABLE books ADD COLUMN Status ENUM('Yes', 'No');
...
ALTER TABLE IssueStatus MODIFY COLUMN Issued_book_name VARCHAR(100);
...
SELECT Category, COUNT(title) FROM books GROUP BY Category;
